...
export default function KaikkiKayttajat(props) {
  ...
  const KayttajaData =  props.kayttajat.map((kayttaja) => {
    return (
      <Table.Row key={ kayttaja.id }>
        ...
        <Table.Cell textAlign='center'>
          <Button compact size='mini' onClick={() => history.push('/kayttajalomake', kayttaja)}>Edit</Button>
          <Button compact size='mini' onClick={() => props.avaaModaali(kayttaja.id)}>Poista</Button>
        </Table.Cell>
      </Table.Row>
    );
  })
