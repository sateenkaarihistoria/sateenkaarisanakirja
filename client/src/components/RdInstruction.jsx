  ...
  return (
    <div className={className}>
      <Container>
        ...
        <h1 id="infoHeader" className="ui header">KÄYTTÖOHJE</h1>
        <div className="ui padded segment">
          ...
          <p>
            Hakusanalistan avulla voit tutkia aakkosjärjestyksessä niitä <b>sanoja ja ilmauksia</b>, joita on käytetty 
            sukupuolen ja seksuaalisuuden moninaisuudesta kirjoitettaessa. Huomaa, että sanojen tallennus päättyy 
            vuoteen 1939. Joidenkin mukaan otettujen sanojen käyttö on jatkunut senkin jälkeen, kun taas toiset 
            ilmaisut ovat sittemmin jääneet pois käytöstä, samalla kun sanomalehtien sivuille on ilmestynyt uusia, 
            tästä hakusanakirjasta puuttumaan jääviä ilmaisuja.   
          </p>
          <p>
            Mukaan otetuille hakusanoille on annettu selite, jonka muotoilu on mahdollisuuksien mukaan poimittu <i>Nykysuomen 
            sanakirjasta</i> (1951–61). Näin on pyritty välttämään karkeita anakronismeja, eli nykyajalle ominaisten 
            ajattelumuotojen siirtämistä menneisyyteen, mutta silti on huomattava, että sanojen vivahteet ovat voineet 
            poiketa uutisen julkaisemisen aikana sanakirjaan painetusta selitteestä. Asiasana puolestaan kertoo nykykäsittein 
            sen aihealueen, johon sanan käyttö läheisimmin viittaa. Sanan tyylilaji taas ilmaisee sen, onko sanalla haluttu 
            esimerkiksi sievistellä asiaa (<i>eufemismi</i>) tai alleviivata sen tuomittavuutta (<i>dysfemismi</i>). 
            Käyttöala viittaa siihen elämänpiiriin, johon käytetty sana on lehdessä liitetty. Usein se on esimerkiksi <i>juridiikka; 
            rikostutkinta; oikeudenkäynti</i>, mutta se voi olla myös vaikkapa <i>kulttuuri</i> tai <i>urheilu</i>.
          </p>
          <p>
            Sanojen ja ilmauksien käyttöyhteydestä antaa lisää viitteitä se sanomalehden osio, jossa esimerkkilause 
            esiintyy. Myös esimerkkilause itsessään tarkentaa sanan käytön piiriä ja merkityksiä. Koska homoseksuaaliset 
            teot olivat rikollisia kyseisenä aikana, useat sanakirjan esimerkkilauseista ovat kielteisesti värittyneitä. 
            Se tietysti kertoo enemmän tuolloin vallinneista asenteista kuin homoseksuaalisuudesta elettynä kokemuksena 
            tai homoseksuaaleista ihmisinä. Esimerkkilauseisiin tutustumalla voit seurata myös sitä, millaisiin 
            asioihin samoillakin käsitteillä on eri aikoina viitattu. Ensimmäisen ja viimeisen ilmestymisen 
            päivämäärän kertoo sanojen esiintymisestä aikavälillä 1904–1939. 
          </p>
          <div className="ui tiny header">Sanakirja-alasivun hakutoiminnot:</div>
          <p>
          Hakukenttään voit kirjoittaa yksittäisiä hakusanoja. Voit käyttää sanankatkaisuja esimerkiksi näin: homo*, 
          *seksuaali,  *suku*. Kirjainvalikon kautta etsiä kaikkia tietyllä kirjaimella alkavia sanoja, tai voit vain 
          selailla sivun vasemmassa reunassa näkyvää sanalistaa. 
          Samaan aihepiiriin liittyviä sanoja voit hakea hakuvalikosta asiasanan avulla. 
          </p>
        </div>
        <div className="ui padded segment">
          ...
          <p>
            ...
            ei tietenkään tarkoita, etteikö siinä silti voisi esiintyä näitäkin teemoja. On hyvin mahdollista, että niitä vain ei ole mainittu sanomalehdessä. 
          </p>
          <p>
            Voit tehdä hakuja halutessasi myös <b><i>teoslajin</i></b> perusteella, jos haluat nähdä listan esimerkiksi kaikista näytelmistä. 
          </p>
          <p>
          ...
          <p>
            Voit tehdä hakuja halutessasi myös <b><i>tekijän ammatin</i></b> perusteella, jos haluat nähdä listan esimerkiksi kaikista kirjailijoista. 
          </p>
          <p>
          ...
          <div className="ui tiny header">Kulttuurituotteita-alasivun hakutoiminnot:</div>
          <p>
        ...
        <div className="ui padded segment">
          ...
          <p>
            ...
            Tutkijoiden kannattaa kohdentaa omat hakunsa myös itse sanomalehteen löytääkseen itse uutisoinnista 
            kaipaamiaan tarkempia lisätietoja.
          </p>
          <div className="ui tiny header">Organisaatiot-alasivun hakutoiminnot:</div>
          <p>
        ...
        <div className="ui padded segment">
          <h3 className="ui header">4) OMIEN HAKUJEN TEKEMINEN DIGITALISOIDUISTA SANOMALEHDISTÄ</h3>
          <p>
          ...
          <p>
            Hyödyntämällä <i>Helsingin Sanomien</i> tilaajilleen tarjoaman <a target="_blank" rel="noopener noreferrer" href="https://www.hs.fi/aikakone/" title="hs.fi/aikakone ">
            Aikakoneen</a> hakumahdollisuuksia pääset halutessasi tutustumaan myös vuoden 1940 jälkeisen ajan uutisointiin ja kielenkäyttöön. 
          </p>
        </div>
      </Container>
    </div>
