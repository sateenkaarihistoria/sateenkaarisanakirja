...
const OrganisaatiotPlain = ({ className }) => {
  ...
  const [aktiivinenOrganisaatio, setAktiivinenOrganisaatio] = useState(
    undefined,
  );
  ...
  const suodataTapahtumatAsiasanalla = suodataKokoelma('tapahtumat')(
    'asiasana',
  );
  ...
  const naytaOrganisaatiot = () => {
    ...
    if (suodatusPaalla) {
      switch (suodatusoptio) {
        case 'kirjainhaku':
        case 'nimi':
          suodatetutOrganisaatiot = suodataOrgNimella(hakutermiTrim)(
            predikaatti,
          )(organisaatiolista);
          break;
        case 'paikkakunta':
          suodatetutOrganisaatiot = suodataPaikkakunnalla(hakutermiTrim)(
            predikaatti,
          )(organisaatiolista);
          break;
        case 'maa':
          suodatetutOrganisaatiot = suodataMaalla(hakutermiTrim)(predikaatti)(
            organisaatiolista,
          );
          break;
        case 'asiasana':
          suodatetutOrganisaatiot = suodataTapahtumatAsiasanalla(hakutermiTrim)(
            predikaatti,
          )(organisaatiolista);
          break;
        default:
