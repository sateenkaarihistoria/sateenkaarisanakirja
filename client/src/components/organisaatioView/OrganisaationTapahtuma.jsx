...
const OrganisaationTapahtuma = ({ tapahtuma, poistoHandler, updateHandler  }) => {
  ...
  return(
    <>
      <Table className="very basic table" textAlign='left'>
        <Table.Body>
          <Table.Row>
            <Table.Cell className="table-label-cell"><b>Tapahtuman nimi</b></Table.Cell>
            <Table.Cell className="table-content-cell">{tapahtuma.nimi}</Table.Cell>
          </Table.Row>
          <Table.Row>
            <Table.Cell className="table-label-cell"><b>Tapahtuman luonne</b></Table.Cell>
            <Table.Cell className="table-content-cell">{tapahtuma.luonne}</Table.Cell>        
          </Table.Row>
          <Table.Row>
            <Table.Cell className="table-label-cell"><b>Tapahtuman vuosi</b></Table.Cell>
            <Table.Cell className="table-content-cell">{tapahtuma.paivays}</Table.Cell>
          </Table.Row>
          <Table.Row>
