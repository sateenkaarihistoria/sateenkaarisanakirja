  ...
  return (
    <>
      <Table className="very basic table" textAlign='left'>
        <Table.Body>
          <Table.Row>
            <Table.Cell className="table-label-cell"><b>Teoksen nimi</b></Table.Cell>
            <Table.Cell className="table-content-cell">{teos.nimi}</Table.Cell>
          </Table.Row>
          <Table.Row>
            <Table.Cell className="table-label-cell"><b>Teoslaji</b></Table.Cell>
            <Table.Cell className="table-content-cell">{teos.lajityyppi}</Table.Cell>
          </Table.Row>
          <Table.Row>
            <Table.Cell className="table-label-cell"><b>Teoksen paikkakunta</b></Table.Cell>
            <Table.Cell className="table-content-cell">{teos.teos_paikkakunta}</Table.Cell>
          </Table.Row>
          <Table.Row>
            <Table.Cell className="table-label-cell"><b>Teoksen maa</b></Table.Cell>
            <Table.Cell className="table-content-cell">{teos.teos_maa}</Table.Cell>
          </Table.Row>
          <Table.Row>
            ...
            <Table.Cell className="table-content-cell">
              <List horizontal>
                {teos.asiasana.map((as, index) => (
                  <List.Item key={index}>{as}</List.Item>
                ))}
              </List>
            </Table.Cell>
          </Table.Row>
